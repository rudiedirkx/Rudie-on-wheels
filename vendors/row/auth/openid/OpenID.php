...
class OpenID extends OpenIDParent {
	...
	public
		$returnUrl,
		$required = array(),
		$optional = array('namePerson/friendly', 'contact/email', 'namePerson', 'birthDate', 'person/gender', 'contact/postalCode/home', 'contact/country/home', 'pref/language', 'pref/timezone'),
		$verify_peer = null,
		$capath = null,
		$cainfo = null,
		$data;
